...
3. **Add to ROADMAP.md** under a `## Backlog` section. If the section doesn't exist, create it at the end.
   ...
   **Plans:** 0 plans
   ...
   Plans:
   - [ ] TBD (promote with /gsdcn-review-backlog when ready)
   ```
...
6. **Report:**
   ...
   Use /gsdcn-discuss-phase {NEXT} to explore it further.
   Use /gsdcn-review-backlog to promote items to active milestone.
   ```
...
- Phase directories are created immediately, so /gsdcn-discuss-phase and /gsdcn-plan-phase work on them
