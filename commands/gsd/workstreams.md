...
`/gsdcn-workstreams [subcommand] [args]`
...
- `/gsdcn-new-milestone --ws <name>` to set up the milestone
...
### resume
Set the workstream as active and suggest `/gsdcn-resume-work --ws <name>`.
