---
name: gsd:scan
description: Rapid codebase assessment — lightweight alternative to /gsdcn-map-codebase
allowed-tools:
  - Read
  - Write
  - Bash
...
Lightweight alternative to `/gsdcn-map-codebase` — spawns one mapper agent instead of four parallel ones.
</objective>
